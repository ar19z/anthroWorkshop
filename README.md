...
3. **Data:** Place your `.mp3` files in `data/unzipped_audio/`.
4. **Execution:** Run the scripts in numerical order (01 through 05).

## Directory Structure
- `data/`: Contains transcripts and generated analysis results.
- `scripts/`: Python logic for transcription, NLP, and visualization.
- Add `unzipped_audio` folder in `data/`
- Download and add files from https://drive.google.com/drive/folders/1-DiGLxm32ZU8pmHy5JepPVaeidn434Tm?usp=sharing to `data/unzipped_audio`
